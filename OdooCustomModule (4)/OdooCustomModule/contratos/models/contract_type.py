...
class ContractType(models.Model):
    ...
    contract_count = fields.Integer(
        ...
        help='Cantidad de contratos activos de este tipo'
    )
    ...
    def _compute_contract_count(self):
        """Calcular el número de contratos por tipo"""
        for contract_type in self:
            contract_type.contract_count = len(contract_type.contract_ids.filtered(
                lambda c: c.state in ['vigente', 'renovado']
            ))
